...
<div class=row"">
      <div class="header">
           ...
           <div class="col-sm-2">
               <br><p>
               <a href="<?php echo base_url(); ?>index.php/Welcome/index" class="btn btn-default btn-sm">
                 <img style="width:40px; height:40px;" src="<?php echo base_url(); ?>public/images/user.jpg" alt="" />
                Log out
               </a>
             </p>
           </div>
