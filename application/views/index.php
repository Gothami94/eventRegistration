      ...
      <div class="header">
		     <div class="header_top">
				 ...
				 <div class="logo">
				  ...
				  <div class="menu">
					<ul>
						<li class="active"><a href="<?php echo base_url(); ?>index.php/test/view/index-2">HOME</a></li>
