...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">NM Theater <span class="lite">Admin</span></a>
            <!--logo end-->
  ...
  <!-- container section end -->
    ...
    <!-- jquery validate js -->
    <script type="text/javascript" src="<?php echo base_url(); ?>admin/js/jquery.validate.min.js"></script>

    <!-- custom form validation script for this page-->
    <script src="<?php echo base_url(); ?>admin/js/form-validation-script.js"></script>
