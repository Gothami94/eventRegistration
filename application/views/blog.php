...
<!-- Mirrored from p.w3layouts.com/demos/events_club/web/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2016 01:28:52 GMT -->
<head>
<title>Namel Malani Punchi Theatre | Blog  </title>
				 ...
				 <div class="logo">
				  ...
				  <div class="menu">
				    ...
				    <li><a href="<?php echo base_url(); ?>index.php/test/view/about">ABOUT</a></li>
				    	...
				    	<li class="active"><a href="<?php echo base_url(); ?>index.php/test/view/blog">BLOG</a></li>
     	    	...
     	    	<div class="blog">
					   ...
					   <!---728x90--->
	    					<div class="blog-leftgrids">
								<div class="image group">
									<div class="grid images_3_of_1">
										<a href="#"><img src="<?php echo base_url(); ?>public/images/blog-img2.jpg" alt=""></a>
									</div>
							...
							<div class="blog-leftgrids">
								<div class="image group">
									<div class="grid images_3_of_1">
										<a href="#"><img src="<?php echo base_url(); ?>public/images/blog-img1.jpg" alt=""></a>
									</div>
										<div class="grid blog-desc">
							...
							<div class="blog-leftgrids">
								<div class="image group">
									<div class="grid images_3_of_1">
										<a href="#"><img src="<?php echo base_url(); ?>public/images/event-img1.jpg" alt=""></a>
									</div>
										<div class="grid blog-desc">
											<h4><span>Duis aute irure dolor cillum dolore</span></h4>
											  <h4>Sep 14TH, 2013,&nbsp;&nbsp; posted By <a href="#" class="post">Lorem ipsum</a></h4>
