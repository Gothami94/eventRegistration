...
<!-- Mirrored from p.w3layouts.com/demos/events_club/web/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2016 01:28:20 GMT -->
<head>
<title>Namel Malani Punchi Theatre | Gallery </title>
...
<body>
      ...
      <div class="header">
           ...
           <b>Namel Malani Punchi Theatre</b><br>
				  ...
				  <div class="menu">
					<ul>
						<li><a href="<?php echo base_url(); ?>index.php/Welcome2/index/index-2">HOME</a></li>
				    	...
				    	<li class="active"><a href="<?php echo base_url(); ?>index.php/test/view/gallery">GALLERY</a></li>
     	     ...
     	     <div class="gallery">
	           ...
	           <div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img1_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img1.jpg" alt=""> <span class="zoom-icon"></span></a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img2_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img2.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img3_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img3.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img4_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img4.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
		   </div>
		   <!---728x90--->
		   <div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img5_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img5.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img6_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img6.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img7_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img7.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo base_url(); ?>public/images/gallery_img8_b.jpg" class="swipebox" title="Image Title"> <img src="<?php echo base_url(); ?>public/images/gallery_img8.jpg" alt=""><span class="zoom-icon"></span> </a>
				</div>
		   </div>
		   <!---728x90--->
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"26612e640c","applicationID":"3365418","transactionName":"NVVXMUVWVkMHBRUPXgwfYBdeGFxVCwkSSVgMVFAdGUdQQA==","queueTime":0,"applicationTime":0,"atts":"GRJURw1MRU0=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>

<!-- Mirrored from p.w3layouts.com/demos/events_club/web/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2016 01:28:52 GMT -->
</html>
