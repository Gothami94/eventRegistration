      ...
      <div class="header">
		     <div class="header_top">
				 ...
				 <div class="logo">
					 ...
					 <a href="<?php echo base_url(); ?>application/view/index-2.php"><img src="<?php echo base_url(); ?>public/images/4.jpg" alt="" /></a>
					 </div>
				  <div class="menu">
					<ul>
						<li class="active"><a href="<?php echo base_url(); ?>application/view/index-2.php">HOME</a></li>
				    	<li><a href="<?php echo base_url(); ?>application/view/about.php">ABOUT</a></li>
				    	<li><a href="<?php echo base_url(); ?>application/view/events.php">EVENTS</a></li>
				    	<li><a href="<?php echo base_url(); ?>application/view/gallery.php">GALLERY</a></li>
				    	<li><a href="<?php echo base_url(); ?>application/view/blog.php">BLOG</a></li>
				    	<li><a href="<?php echo base_url(); ?>application/view/contact.php">CONTACT</a></li>
				    	<div class="clear"></div>
				    </ul>
				 </div>
			     <div class="clear"></div>
		  ...
		  <div class="slider">
	      	<div class="slider-wrapper theme-default">
	            <div id="slider" class="nivoSlider">
	                <img src="<?php echo base_url(); ?>public/images/1.jpg" data-thumb="images/1.jpg" alt="" />
	                <img src="<?php echo base_url(); ?>images/2.jpg" data-thumb="images/2.jpg" alt="" />
	                <img src="<?php echo base_url(); ?>images/3.jpg" data-thumb="images/3.jpg" alt="" />
	                <img src="<?php echo base_url(); ?>images/4.jpg" data-thumb="images/4.jpg" alt="" />
	                 <img src="<?php echo base_url(); ?>images/5.jpg" data-thumb="images/5.jpg" alt="" />
	            </div>
	        </div>
   		</div>
   	  </div>
     	   ...
     	   <div class="section group">
				<div class="listview_1_of_3 images_1_of_3 event_grid">
					...
					<div class="listimg listimg_1_of_2">
						  <img src="<?php echo base_url(); ?>images/event_1.jpg" alt="" />
					</div>
				...
				<div class="listview_1_of_3 images_1_of_3 event_grid">
					<a href="events.html">
					<div class="listimg listimg_1_of_2">
						  <img src="<?php echo base_url(); ?>images/event_2.jpg" alt="" />
					</div>
					<div class="text list_1_of_2">
						<div class="date">
				...
				<div class="listview_1_of_3 images_1_of_3 event_grid">
					<a href="events.html">
					<div class="listimg listimg_1_of_2">
						  <img src="<?php echo base_url(); ?>images/event_3.jpg" alt="" />
					</div>
					<div class="text list_1_of_2">
						<div class="date">
			...
			<!---728x90--->
			 ...
			 <div class="section group">
				<div class="col_1_of_3 span_1_of_3 today_show">
					<h3>Today's Show</h3>
					<img src="<?php echo base_url(); ?>images/today_show.jpg" alt="" />
				...
				<div class="col_1_of_3 span_1_of_3">
					<h3>Latest Videos</h3>
					  <a href="gallery.html"><img src="<?php echo base_url(); ?>images/videos.jpg" alt="" /></a>
