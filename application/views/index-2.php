      ...
      <div class="header">
		     <div class="header_top">
				 ...
				 <div class="logo">
				  ...
				  <div class="menu">
					<ul>
						<li class="active"><a href="<?php echo base_url(); ?>application/view/index-2.html">HOME</a></li>
				    	...
				    	<li><a href="<?php echo base_url(); ?>application/view/gallery.html">GALLERY</a></li>
		  ...
		  <div class="slider">
	      	<div class="slider-wrapper theme-default">
	            <div id="slider" class="nivoSlider">
	                <img src="<?php echo base_url(); ?>images/1.jpg" data-thumb="images/1.jpg" alt="" />
