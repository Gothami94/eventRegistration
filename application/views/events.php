...
(adsbygoogle = window.adsbygoogle || []).push({});
				 ...
				 <div class="logo">
				  ...
				  <div class="menu">
					<ul>
				    	...
				    	<li class="active"><a href="<?php echo base_url(); ?>application/views/events.php">EVENTS</a></li>
							...
							<div class="grid_1_of_3 events_1_of_3">
							  <div class="event-time">
								<h4><span>sed quia non numqua</span></h4>
							     ...
							     <div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img1.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img2.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img3.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
					   </div>
					   <!---728x90--->
					   <div class="section group">
							<div class="grid_1_of_3 events_1_of_3">
							  <div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img4.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img5.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>images/event-img6.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
					   </div>
	        		</div>
     ...
     <div class="footer">
       <div class="wrap">
        ...
        <div class="footer-pic"><img src="<?php echo base_url(); ?>images/foot-icon.png" alt=""></div>
        </div>
    	<div class="clear"></div>
      </div>
    </div>
