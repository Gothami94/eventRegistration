...
<!-- Mirrored from p.w3layouts.com/demos/events_club/web/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2016 01:27:50 GMT -->
<head>
<title>Namel Malani Punchi Theatre | Events </title>
      ...
      <div class="header">
		     <div class="header_top">
				 ...
				 <div class="logo">
				  ...
				  <div class="menu">
					<ul>
						<li><a href="<?php echo base_url(); ?>index.php/Welcome2/index">HOME</a></li>
				    	<li><a href="<?php echo base_url(); ?>index.php/test/view/about">ABOUT</a></li>
				    	<li class="active"><a href="<?php echo base_url(); ?>index.php/test/view/events">EVENTS</a></li>
							...
							<div class="grid_1_of_3 events_1_of_3">
							  <div class="event-time">
								<h4><span>sed quia non numqua</span></h4>
							     ...
							     <div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img1.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img2.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img3.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
					   </div>
					   <!---728x90--->
					   <div class="section group">
							<div class="grid_1_of_3 events_1_of_3">
							  <div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img4.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img5.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
							<div class="grid_1_of_3 events_1_of_3">
								<div class="event-time">
								...
								<div class="event-img">
								    <a href="blog.html"><img src="<?php echo base_url(); ?>public/images/event-img6.jpg" alt=""><span>Read More</span></a>
							   </div>
							</div>
					   </div>
	        		</div>
...
<!-- Mirrored from p.w3layouts.com/demos/events_club/web/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Nov 2016 01:28:20 GMT -->
</html>
